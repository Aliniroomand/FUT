"""add sample_html to alerts

Revision ID: 3ffd8d3fc203
Revises: 5e64d9b6bffd
Create Date: 2025-09-13 09:47:33.827043
...
revision: str = '3ffd8d3fc203'
down_revision: Union[str, Sequence[str], None] = '5e64d9b6bffd'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('alerts', schema=None) as batch_op:
        batch_op.add_column(sa.Column('sample_html', sa.Text(), nullable=True))
        batch_op.add_column(sa.Column('sample_meta', sa.String(), nullable=True))
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('alerts', schema=None) as batch_op:
        ...
        batch_op.drop_column('sample_html')

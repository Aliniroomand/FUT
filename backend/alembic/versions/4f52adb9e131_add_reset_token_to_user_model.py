...
Revision ID: 4f52adb9e131
Revises: 9adf5a2d3ef2
Create Date: 2025-07-30 00:52:40.395068
...
revision: str = '4f52adb9e131'
down_revision: Union[str, Sequence[str], None] = '9adf5a2d3ef2'
...
def downgrade() -> None:
    ...
    sa.Column('bank_account_number', sa.VARCHAR(), nullable=True),
    sa.Column('bank_account_name', sa.VARCHAR(), nullable=True),

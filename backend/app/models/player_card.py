...
class PlayerCard(Base):
    ...
    max_bid_price = Column(Integer, default=0)
    min_bid_price = Column(Integer, default=0)
    max_buy_now_price = Column(Integer, default=0)
    min_buy_now_price = Column(Integer, default=0)

...
import messi from "../assets/messi-2.webp";
import ronaldo from "../assets/ronaldo.webp";
import mbappe from "../assets/mbape-2.webp";
  ...
  return (
    <div className="relative min-h-screen text-white overflow-hidden flex flex-col">
      ...
      <div className="flex-grow relative">
        {/* Desktop layout */}
        <div className="hidden lg:grid grid-cols-4 absolute bottom-0 w-full items-end justify-items-center pb-4">
          {/* امباپه با سکه ربات تلگرام */}

          <div className="relative h-full w-full flex flex-col-reverse items-start left-8 ">
            <img
              src={mbappe}
              alt="Mbappe"
              className=" h-full  aspect-auto absolute bottom-0 animate-float-slow"
            />
            <div
        ...
        <div className="lg:hidden flex flex-col items-center mt-8 mb-6">
          ...
          <div
            className="w-24 h-24 bg-cover bg-center bg-no-repeat mt-4 rounded-full flex items-center justify-center text-black text-xs font-bold animate-bounce"
            style={{
              backgroundImage: `url(${bgCoin})`,
            }}
          >
